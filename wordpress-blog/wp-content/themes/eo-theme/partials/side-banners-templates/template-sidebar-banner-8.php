<?php 
/* Template Name: sidebar-banner-8 */

// Set variables for this category
$categoryName = 'Construction';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/health.png';  // Corrected icon path
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Construction.webp';
?>
