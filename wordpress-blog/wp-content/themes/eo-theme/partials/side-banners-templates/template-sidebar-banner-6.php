<?php 
/* Template Name: sidebar-banner-6 */

// Define category-specific variables
$categoryName = 'Textile';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/textiles.png';
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Textile.webp';
?>
