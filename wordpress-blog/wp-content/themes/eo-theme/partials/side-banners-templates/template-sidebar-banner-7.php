<?php 
/* Template Name: sidebar-banner-7 */

// Define category-specific variables
$categoryName = 'Mining';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/mining.png'; // Corrected icon path
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Mining.webp';
?>
