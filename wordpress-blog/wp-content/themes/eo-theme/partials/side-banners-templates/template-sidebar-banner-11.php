<?php 
/* Template Name: sidebar-banner-11 */

// Define category variables for reuse
$categoryName = 'Defense & Space';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/health.png';  // Correct icon path
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Defence.webp';
?>
...
<div class="side-banner-section">
    <div class="side-banner-wrapper">
        ...
        <!-- Banner Body Section -->
        <div class="side-banner-body" style="background: #131416 url('<?php echo esc_url($backgroundImage); ?>') no-repeat center center; background-size: cover;">
