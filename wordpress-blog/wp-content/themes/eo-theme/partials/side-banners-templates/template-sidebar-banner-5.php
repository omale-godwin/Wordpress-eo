<?php 
/* Template Name: sidebar-banner-5 */

// Define category-specific variables
$categoryName = 'Technology';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/techh.png';
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Technology.webp';
?>
