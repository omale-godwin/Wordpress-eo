<?php 
/* Template Name: sidebar-banner-2 */

// Define category-specific values
$categoryName = 'Manufacturing';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/manufac.png';
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Manufacturing.webp';
?>
