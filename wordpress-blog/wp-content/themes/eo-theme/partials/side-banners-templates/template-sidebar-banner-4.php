<?php 
/* Template Name: sidebar-banner-4 */

// Define category-specific variables
$categoryName = 'Telecom';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/telecom.png';
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Telecom.webp';
?>
