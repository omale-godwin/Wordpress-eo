<?php 
/* Template Name: sidebar-banner-3 */

// Custom values for this specific banner
$categoryName = 'Logistics';
$categoryIcon = 'https://cdn.electricoctopus.agency/electric-octopus/blog/logostic.png';
$backgroundImage = get_template_directory_uri() . '/assets/images/sidebar-template/Logistics.webp';
?>
