<?php
/* Template Name: Article Layout 5 */
    ...
    <div class="detail-content">
        <div class="detail-content-left">
            ...
            <div id="search-filtered-posts">
                ...
                <!-- Head Section -->
                <?php 
                $head_image_block = get_field('head_image_block');
                ?>

                <div class="hd-banner-image mt-24 flex gap-24">
                    <div class="banner-image-left">
                        <?php 
                        if (!empty($head_image_block['head_image_block_1'])) :
                        ?>
                            <div class="detail-fetured-img mt-24">
                                <?php echo wp_get_attachment_image($head_image_block['head_image_block_1'], 'full'); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="banner-image-right">
                        <?php 
                        if (!empty($head_image_block['head_image_block_2'])) :
                        ?>
                            <div class="detail-fetured-img mt-24">
                                <?php echo wp_get_attachment_image($head_image_block['head_image_block_2'], 'full'); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
              ...
              <!-- Banner Image-->
                ...
                <!-- creative team -->
                    <?php
                        ...
                        <div class="flex align-item-center gap-24 mt-24">
                            <div class="creative-t w-50">
                                ...
                                <?php endif; ?>
                                <?php if ($content_1) : ?>
                                    <p class="creative-t-p"><?php echo esc_html($content_1); ?></p>
                                <?php endif; ?>
                                <?php if ($content_2) : ?>
                                    <p class="creative-para"><?php echo esc_html($content_2); ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="w-50">
                                <?php if ($image_id) : ?>
                    ...
                    <!-- Body Banner 2-->
                <?php
                    $cta_group = get_field('body_banner_group_2');
                    ...
                    <!-- body CTA banner -->
                <?php
                    $cta_group = get_field('cta_banner_group');

                    if (
                        isset($cta_group['enable_cta_banner']) &&
                        $cta_group['enable_cta_banner'] &&
                        !empty($cta_group['cta_banner_block'])
                    ) {
                        $block = $cta_group['cta_banner_block'];

                        if (isset($block['select_cta_banner'])) {
                            $selected_banner = $block['select_cta_banner']; // e.g., 'banner1'
                            $banner_number = str_replace('banner', '', $selected_banner); // e.g., '1'
                            $field_key = 'banner_' . $banner_number . '_fields'; // banner_1_fields
                            $template_part = 'template-parts/cta/content-article-body-banner' . $banner_number;
                    ...
                    <!-- Body Banner 3-->
                <?php
                    $cta_group = get_field('body_banner_group_3');
                    ...
                    ?> 
                    <!-- COntent section-->
                    <?php if ( have_rows('content_section_7') ) : ?>
                        <div class="content-section-wrapper">

                            <?php while ( have_rows('content_section_7') ) : the_row(); ?>
