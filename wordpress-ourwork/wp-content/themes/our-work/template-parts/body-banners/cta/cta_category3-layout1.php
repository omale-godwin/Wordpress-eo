...
<?php if ($enabled): ?>
<div class="banner-template-cat-3 cta-bdy-cls" style="background:#1A1036">
        ...
        <?php if (!empty($repeater_items)): ?>
            <ul class="cta-list">
                <?php foreach ($repeater_items as $item): ?>
                    <li> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/yl-tick.png" alt="tick" loading="lazy"><?php echo esc_html($item['item']); ?></li>
                <?php endforeach; ?>
            </ul>
        <?php endif; ?>
