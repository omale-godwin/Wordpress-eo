...
<?php if ($enabled): ?>
<div class="banner-template-layout-5 cta-bdy-cls" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/cta-banner-cat4/cat4-banner-bg5.webp')">
    <div class="maxw-410">
        <?php if ($heading): ?>
            <h2 class="layout5-headline green-color"><?php echo esc_html($heading); ?></h2>
        <?php endif; ?>
