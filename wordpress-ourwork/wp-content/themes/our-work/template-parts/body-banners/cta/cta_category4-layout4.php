...
<?php if ($enabled): ?>
<div class="banner-template-cat-4 cta-bdy-cls" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/cta-banner-cat4/cat4-banner-bg4.webp')">
    ...
    <!-- Left graphic -->
    <div>
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cta-banner-cat4/cat4-img4.webp" alt="graph" loading="lazy">
    </div>
