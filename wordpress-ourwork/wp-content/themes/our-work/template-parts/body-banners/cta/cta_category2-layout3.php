...
<?php if ($enabled): ?>
<div class="banner-template-cat-2 cta-bdy-cls" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/cta-banner-cat2/03-Banner.webp)">
