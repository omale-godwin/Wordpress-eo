jQuery(document).ready(function ($) {
    ...
    function fetchPosts() {
        ...
        $.ajax({
            ...
            data: filters,
            beforeSend: function () {
                $("#filtered-posts").html("<p class='white-color'>Loading...</p>");
            },
    ...
    function updateTags() {
        ...
        if (selectedCategory || selectedIndustry || searchQuery.length > 0) {
            $("#filtered-posts .case-study-post-block:visible").each(function () {
            ...
            $(".case-study-tags .custom-tag-link").each(function () {
                let tagID = $(this).data("tag-id");
    ...
    $(document).on("click", ".custom-tag-link.enabled", function () {
        ...
        $(".case-study-post-block .custom-tag-link").each(function () {
