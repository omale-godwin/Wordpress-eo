...
?>
<div class="banner-template-1 cta-bdy-cls" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/template-previews/cta-banner/cta-img1.webp')">
